...
# Data
UOP_Celldensities =     pd.read_csv('../DataUOP/UOP_celldensities.csv', index_col=0)
UOP_Function =          pd.read_csv('../DataUOP/UOP_functional.csv', index_col=0)
UOP_Metavariables =     pd.read_csv('../DataUOP/UOP_metavariables.csv', index_col=0)
UOP_Neighborhood =      pd.read_csv('../DataUOP/UOP_neighborhood.csv', index_col=0)
...
UOP_y = pd.read_csv('../DataUOP/UOP_outcome.csv',index_col=0)
UOP_y = UOP_y.grade-1
...
STA_Celldensities =     pd.read_csv('../DataSTA/STA_celldensities.csv', index_col=0)
STA_Function =          pd.read_csv('../DataSTA/STA_functional.csv', index_col=0)
STA_Metavariables =     pd.read_csv('../DataSTA/STA_metavariables.csv', index_col=0)
STA_Neighborhood =      pd.read_csv('../DataSTA/STA_neighborhood.csv', index_col=0)
...
STA_y = pd.read_csv('../DataSTA/STA_outcome.csv',index_col=0)
STA_y = STA_y.grade-1
train_data_dict = UOP_data
test_data_dict = STA_data
# Results folder
result_folder = "./ModelUOP"
# Main script
