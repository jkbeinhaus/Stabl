...
# Data
UOP_Celldensities =     pd.read_csv('../UOPdatawithMDSCs/UOPreanalysis_celldensities.csv', index_col=0)
UOP_Function =          pd.read_csv('../UOPdatawithMDSCs/UOPreanalysis_functional.csv', index_col=0)
UOP_Metavariables =     pd.read_csv('../UOPdatawithMDSCs/UOPreanalysis_metavariables.csv', index_col=0)
UOP_Neighborhood =      pd.read_csv('../UOPdatawithMDSCs/UOPreanalysis_neighborhood.csv', index_col=0)
...
UOP_y = pd.read_csv('../UOPdatawithMDSCs/UOPreanalysis_outcome.csv',index_col=0)
UOP_y = UOP_y.grade-1
...
STA_Celldensities =     pd.read_csv('../STAdatawithMDSCs/STAreanalysis_celldensities.csv', index_col=0)
STA_Function =          pd.read_csv('../STAdatawithMDSCs/STAreanalysis_functional.csv', index_col=0)
STA_Metavariables =     pd.read_csv('../STAdatawithMDSCs/STAreanalysis_metavariables.csv', index_col=0)
STA_Neighborhood =      pd.read_csv('../STAdatawithMDSCs/STAreanalysis_neighborhood.csv', index_col=0)
...
STA_y = pd.read_csv('../STAdatawithMDSCs/STAreanalysis_outcome.csv',index_col=0)
STA_y = STA_y.grade-1
