...
from sklearn.model_selection import RepeatedStratifiedKFold, GroupShuffleSplit
...
# Results folder
result_folder = "./Reanalysis"
UOP_y['patient_id'] = UOP_y.index.str.split('_').str.get(0)
groups = UOP_y.patient_id
...
outer_splitter = GroupShuffleSplit(n_splits=100,test_size=0.2,random_state=111)
