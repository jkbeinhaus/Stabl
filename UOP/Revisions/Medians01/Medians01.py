...
# Data
UOP_Celldensities =     pd.read_csv('../DataUOPmedians/UOPmedian_celldensities.csv', index_col=0)
UOP_Function =          pd.read_csv('../DataUOPmedians/UOPmedian_functional.csv', index_col=0)
UOP_Metavariables =     pd.read_csv('../DataUOPmedians/UOPmedian_metavariables.csv', index_col=0)
UOP_Neighborhood =      pd.read_csv('../DataUOPmedians/UOPmedian_neighborhood.csv', index_col=0)
...
UOP_y = pd.read_csv('../DataUOPmedians/UOPmedian_outcome.csv',index_col=0)
UOP_y = UOP_y.grade-1
...
STA_Celldensities =     pd.read_csv('../DataStanford2medians/STA2median_celldensities.csv', index_col=0)
STA_Function =          pd.read_csv('../DataStanford2medians/STA2median_functional.csv', index_col=0)
STA_Metavariables =     pd.read_csv('../DataStanford2medians/STA2median_metavariables.csv', index_col=0)
STA_Neighborhood =      pd.read_csv('../DataStanford2medians/STA2median_neighborhood.csv', index_col=0)
